...
OntoFlow(온토플로우)는 업무 데이터 모델과 업무 절차 실행을 연결해, 사람이 이해하고 추적할 수 있는 업무 자동화를 만들기 위한 공개 아키텍처 프로젝트입니다.
...
OntoFlow는 공개 기여를 환영합니다. 기여자는 기여 내용에 따라 공개 문서에 이름과 기여 내용이 표기될 수 있습니다.
