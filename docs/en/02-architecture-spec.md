...
[한국어](../ko/02-architecture-spec.md)

This is an English summary of the Korean reference architecture specification.
...
For the full specification, see the Korean reference document.
